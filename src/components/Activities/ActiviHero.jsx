...
const ActiviHero = () => {
  return (
    ...
    >
      ...
      font-palanquin  md-plus:justify-evenly pb-6"
      >
        <h1 className="text-3xl md-plus:max-w-sm  md-plus:text-4xl mt-4 font-bold">
          Energizing Beach <span className="text-coral-red">Workouts!</span>
        </h1>
        <p className="text-sm md-plus:text-lg md-plus:max-w-lg  font-montserrat ">
      ...
      <div className="p-2 md-plus:h-96 object-contain flex md-plus:justify-center ">
        <video
