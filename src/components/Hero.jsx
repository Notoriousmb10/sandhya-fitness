...
const Hero = () => {
  return (
    ...
    min-w-md max-sm:text-center md:max-w-md">
      <div>
      ...
      <div>
      <button className="border-coral-red border-2 p-2 m-2 rounded-lg">Join Now</button>
      <button className="border-coral-red border-2 p-2 m-2 rounded-lg">Sneak Us</button>
      </div>
    </div>
  );
};
