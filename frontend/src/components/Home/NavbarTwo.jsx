      ...
      <div className="flex items-center gap-6 text-2xl">
        ...
        {user ? (
          <div className="relative flex items-center gap-2" ref={dropdownRef}>
            <button
              className="bg-coral-red border-2 flex hover:bg-red-400 items-center gap-2 p-2 rounded-md"
            ...
            >
              ...
              />
              <span className="font-bold text-slate-100 text-sm">{user.firstname}</span>
              <FaCaretDown className="text-slate-100" /> 
            </button>
            {dropdownOpen && (
              <div className="absolute right-0 mt-20 w-20 bg-coral-red font-bold  border rounded-md shadow-lg">
                <button
                  className="block w-full text-left px-4 py-2 text-sm text-white hover:bg-red-400"
